...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setStyles() {
        ...
        //BarButtonItem
        var attributes = [ NSAttributedStringKey.font: UIFont.dinProMedium(17), NSAttributedStringKey.foregroundColor: UIColor.white]
        UIBarButtonItem.appearance().setTitleTextAttributes(attributes, for: UIControlState())
        attributes = [ NSAttributedStringKey.font: UIFont.dinProMedium(17), NSAttributedStringKey.foregroundColor: UIColor.white]
